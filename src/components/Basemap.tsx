...
// night.bg #0A0F1A (hue 221, 44%, L 7%), so the map floated on the UI as a lighter,
...
// read light against the near-black ground and basemap and night UI are one surface. Tiles,
