...
export function PlaceInfoCard({
  ...
  const { t } = useI18n();
  return (
    <div className="absolute bottom-3 left-3 z-[1000] w-72 rounded-card border border-slate-100 bg-white/95 p-4 shadow-lg backdrop-blur dark:border-white/10 dark:bg-night-raised/95">
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <button
            ...
            className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full transition hover:bg-amber-50 dark:hover:bg-night-hover"
          >
            <span
              aria-hidden="true"
          ...
          <button
            ...
            onClick={onClose}
            className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full text-slate-400 transition hover:bg-slate-100 dark:hover:bg-night-hover"
          >
